...
const factory = (tagName) => {
  function vnode(param1, param2) {
    if (Array.isArray(param1)) {
      return utils.h(tagName, param2, ...param1);
    } else {
      return utils.h(tagName, param1, ...param2 ?? []);
    }
  }
  return vnode;
};
...
exports.build = utils.build;
exports.evaluate = utils.evaluate;
exports.htm = utils.htm;
exports.html = utils.html;
exports.treeify = utils.treeify;
exports.a = a;
exports.abbr = abbr;
